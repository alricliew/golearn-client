  ...
  // Employee (TODO: Add new employee login username here)
  const EMPLOYEE_LIST = ['admin@golearn.com.my', 'support@golearn.com.my', '+601115131661', '+60138252818'];
  const EMPLOYEE_ROLE_SUPER_ADMIN = 'superadmin';
  const EMPLOYEE_ROLE_ADMIN = 'admin';
  const EMPLOYEE_ROLE_EDITOR = 'editor';
  const EMPLOYEE_ROLE_AUTHOR = 'author';
  const EMPLOYEE_ROLE_CONTRIBUTOR = 'contributor';
  const EMPLOYEE_ROLE_SUBSCRIBER = 'subscriber';

  const EMPLOYEE_ROLE_LIST = 
    { 
      'admin@golearn.com.my' : EMPLOYEE_ROLE_SUPER_ADMIN, 
      'support@golearn.com.my': EMPLOYEE_ROLE_ADMIN, 
      '+601115131661': EMPLOYEE_ROLE_ADMIN, 
      '+60138252818': EMPLOYEE_ROLE_SUPER_ADMIN
    };

// Admin Specific Constant 
// Admin Profile Obj
const PROFILE_ADMIN_INFO = "adminInfoObj";